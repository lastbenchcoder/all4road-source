<%@ Page Title="" Language="C#" MasterPageFile="~/administration/dashboard.Master" AutoEventWireup="true" CodeBehind="alladmin.aspx.cs" Inherits="DDWBlogger.Project.Source.administration.admin.alladmin" %>
                        ...
                        <table class="table table-hover table-nomargin table-bordered dataTable">
                            ...
                            <tbody>
                                <%foreach (var item in Administrator)
                                    { %>
                                <tr>
                                    <td> <img src="../../<%=item.Banner%>" width="50" height="50" /></td>
                                    ...
                                    <td>
                                        <a href="/administration/profile.aspx?adminid=<%=item.AdministratorId %>&pageId=1234"><i class="fa fa-edit fa-lg"></i></a>
                                    </td>
                                </tr>
                                <%} %>
                            </tbody>
