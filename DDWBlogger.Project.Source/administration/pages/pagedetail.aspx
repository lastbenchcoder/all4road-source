<%@ Page Title="" Language="C#" MasterPageFile="~/administration/dashboard.Master" AutoEventWireup="true" CodeBehind="pagedetail.aspx.cs" 
    Inherits="DDWBlogger.Project.Source.administration.pages.pagedetail" ValidateRequest="false" %>
    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="#"><asp:Label ID="bcTitle" runat="server"></asp:Label></a>
                    <i class="fa fa-angle-right"></i>
                </li>
            </ul>
