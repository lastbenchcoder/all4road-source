<%@ Page Title="" Language="C#" MasterPageFile="~/adminregular/regulardashboard.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="articledetail.aspx.cs" Inherits="DDWBlogger.Project.Source.adminregular.article.articledetail" %>
                        ...
                        <div class='form-horizontal form-striped'>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red"
                                        ErrorMessage="Select Sub Category(Category)" ControlToValidate="ddlCatSubCat" ValidationGroup="admin" InitialValue="Select.."></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="txtTitle" class="control-label col-sm-2">Title</label>
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="FirstName"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid Image !.." ValidationGroup="admin" ControlToValidate="imgInp" ForeColor="Red" ValidationExpression="^.+(.jpeg|.jpg|.JPG|.gif|.GIF|.PNG|.png)$"></asp:RegularExpressionValidator>
                            ...
                            <asp:Panel ID="pnlRole" runat="server" Visible="false">
                                <div class="form-group">
                                    <label for="selSubCat" class="control-label col-sm-2">Status</label>
                                    <div class="col-sm-10">
                                        <asp:DropDownList ID="ddlStatus" runat="server" class="form-control" Style="width: 250px">
                                            <asp:ListItem>Select..</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ForeColor="Red"
                                            ErrorMessage="Select Status" ControlToValidate="ddlStatus" ValidationGroup="admin" InitialValue="Select.."></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </asp:Panel>
                            ...
                            <div class="form-actions col-sm-offset-2 col-sm-10">
                                ...
                                &nbsp;&nbsp;
                                <a href="/adminregular/dashboard.aspx?redirectUrl=dashboard-administrator-home&pageId=1234HJHJKJ*7987979" class="btn btn-brown">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
