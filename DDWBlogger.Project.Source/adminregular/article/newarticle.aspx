<%@ Page Title="" Language="C#" MasterPageFile="~/adminregular/regulardashboard.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="newarticle.aspx.cs" Inherits="DDWBlogger.Project.Source.adminregular.article.newarticle" %>
                    ...
                    <div class="box-content nopadding">
                        <div class='form-horizontal form-striped'>
                            ...
                            <div class="form-actions col-sm-offset-2 col-sm-10">
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn btn-primary" ValidationGroup="article" OnClick="btnSubmit_Click" />
                                 &nbsp;&nbsp;
