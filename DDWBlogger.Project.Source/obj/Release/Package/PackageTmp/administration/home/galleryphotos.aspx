<%@ Page Title="" Language="C#" MasterPageFile="~/administration/dashboard.Master" AutoEventWireup="true" CodeBehind="galleryphotos.aspx.cs" Inherits="DDWBlogger.Project.Source.administration.home.galleryphotos" %>
    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="/administration/home/Gallerydetail.aspx?galid=<%=hdnGalleryId.Value %>">
                    ...
                    <div class="box box-color box-bordered">
                        ...
                        <div class="box-content nopadding">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:Image ID="imgGallery" runat="server" ClientIDMode="Static" Width="100px" Height="100px" class="form-control" />
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton
                                            ID="LinkGallerys"
                                            runat="server"
                                            CommandArgument='<%#Eval("Gallery_Banner_Id")%>'
                                            OnCommand="Gallery_Command"
                                            Text='Set As Default'></asp:LinkButton>
                                        &nbsp;&nbsp;&nbsp;
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%# "../../"+ Eval("Gallery_Banner_Photo") %>' Width="100px" Height="100px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Gallery_Banner_Id" HeaderText="Banner Id" />
                                <asp:BoundField DataField="Gallery_Banner_Default" HeaderText="Is Default Image(1=Yes and 0=No)" />
                                <asp:CommandField ButtonType="Button" HeaderText="Delete" ShowDeleteButton="True" />
                            </Columns>
                            <EmptyDataTemplate>
                                There are no Gallery banners founnd.
                            </EmptyDataTemplate>
                        </asp:GridView>
